...
Table 2.1 shows an example of four consecutive events in our data. This play consists of two consecutive passes, a duel on the ball, and ends with a shot taken by Arsenal. 
...
Processing the JSON files and transforming the coordinates can be implemented with functions in the [**scoutr**](https://github.com/shawnsanto/scoutr) package. 
