...
glmer_baseline_aug %>% 
  ...
  kbl(caption = "Residuals vs. Derby for the baseline hierarchical logistic model.", escape=F, booktabs = TRUE, digits = 3,
...
glmer_pace_aug %>% 
  ...
  kbl(caption = "Residuals vs. Derby for the pace hierarchical logistic model.", escape=F, booktabs = TRUE, digits = 3,
      col.names = c("Derby", "Mean Residual"), align = "c"
  ) %>% 
  kable_styling(latex_options = c("hold_position"))
```
...
multinom_baseline_aug %>% 
  ...
  kbl(caption = "Residuals vs. Derby for the baseline multinomial logistic model.", escape=F, booktabs = TRUE, digits = 8,
      col.names = c("", "0", "1")
  ) %>% 
  kable_styling(latex_options = c("hold_position"))
```
...
multinom_baseline_aug %>% 
  ...
  select(` `, everything()) %>% 
  kableExtra::kbl(caption = "Residuals vs. Home  for the baseline multinomial logistic model.", 
...
multinom_pace_aug %>% 
  ...
  mutate(response = c("Loss", "Draw", "Win")) %>% 
  select(response, everything()) %>% 
  kbl(caption = "Residuals vs. Derby for the pace multinomial logistic model.", escape=F, booktabs = TRUE, digits = 8,
      col.names = c("", "0", "1")
  ) %>% 
  kable_styling(latex_options = c("hold_position"))
```
...
multinom_pace_aug %>% 
  ...
  mutate(` ` = c("Loss", "Draw", "Win")) %>% 
  select(` `, everything()) %>% 
  kableExtra::kbl(format = "html", caption = "Residuals vs. Home  for the pace multinomial logistic model.", 
      booktabs = TRUE) %>% 
  #kableExtra::kable_styling(latex_options = c("hold_position")) %>% 
  kableExtra::scroll_box()
...
#   DT::datatable(caption = htmltools::tags$caption(
#     style = 'caption-side: bottom; text-align: center;',
#     'Table 6.10: ', htmltools::em('Residuals vs. Home for the pace multinomial logistic model.')
#   ), options = list(scrollX = TRUE))
```
