...
```{r epl-attacking-grids, fig.align = "center", fig.cap="Grid analysis of total speed by team vs. EPL average while attacking. Select teams are ordered by final standings from the 2017-18 season. All units are in m/s.", fig.width=14}
epl_10 <- epl_grids %>% 
...
```{r epl-defense-grids, fig.align = "center", fig.cap="Grid analysis of total speed by team vs. EPL average while defending. Select teams are ordered by final standings from the 2017-18 season. All units are in m/s.", fig.width=14}
